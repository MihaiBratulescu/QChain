...
internal static class SetOperation<T, Q>
{
    ...
    private static IQueryShape Apply(SequenceQueryShape<T, Q> left, IQueryShape right, SetOperationKind kind)
    {
    ...
    private static readonly MethodInfo DistinctTypedMethod =
        typeof(SetOperation<T, Q>).GetMethod(nameof(DistinctTyped), BindingFlags.NonPublic | BindingFlags.Static)!;

    private static readonly MethodInfo SetOperationTypedMethod =
        typeof(SetOperation<T, Q>).GetMethod(nameof(SetOperationTyped), BindingFlags.NonPublic | BindingFlags.Static)!;
